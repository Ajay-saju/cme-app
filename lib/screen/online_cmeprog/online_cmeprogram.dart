      ...
      builder: ((_) {
        return GestureDetector(
          ...
          child: Scaffold(
            ...
            body: cmeProgramController.allCmeVideos.value == null
                ? Center(
                                            ...
                                            Padding(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Spacer(),
                                                  Text(
                                                    "Created by ${data[index].speakerName}"
                                                        .toString(),
                                                    style: TextStyle(
                                                      fontSize: 12,
                                                      // fontWeight:
